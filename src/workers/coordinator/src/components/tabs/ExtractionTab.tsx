          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b border-neutral-200 dark:border-neutral-700">
                <tr>
                  <th className="text-left py-2 px-4 font-medium text-neutral-900 dark:text-neutral-100">
                    URL
                  </th>
                  <th className="text-left py-2 px-4 font-medium text-neutral-900 dark:text-neutral-100">
                    Status
              ...
              <tbody>
                {pagesData.pages.slice(0, 10).map((page) => (
                  ...
                  >
                    <td className="py-2 px-4 text-neutral-700 dark:text-neutral-300 truncate max-w-md">
                      {page.url}
                    </td>
          ...
          <>
                    ...
                    >
                      ...
                      {entityTab === "events" && (
                        <>
                          ...
                          <td className="py-2 px-4 text-neutral-600 dark:text-neutral-400 text-xs">
                            {entity.start_ts &&
                              new Date(entity.start_ts).toLocaleDateString()}
                          </td>
                        </>
                      )}
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="text-sm text-neutral-600 dark:text-neutral-400">
                ...
                {Math.min((page + 1) * limit, entitiesData.total)} of{" "}
                {entitiesData.total}
              </div>
