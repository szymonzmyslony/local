...
export type ExtractedTableName = "extracted_artists" | "extracted_galleries" | "extracted_events";
export type GoldenTableName = "golden_artists" | "golden_galleries" | "golden_events";
export type LinksTableName = "extracted_artist_links" | "extracted_gallery_links" | "extracted_event_links";

// Helper to get extracted table name from entity type
export function getExtractedTableName(entityType: EntityType): ExtractedTableName {
	switch (entityType) {
		case "artist":
