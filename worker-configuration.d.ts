/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6cfa31ca21889f6adf5bd00b2430b970)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    SCRAPE_WORKFLOW: Workflow<
      Parameters<import("./src/server").ScrapeWorkflow["run"]>[0]["payload"]
    >;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, "OPENAI_API_KEY" | "FIRECRAWL_API_KEY">
    > {}
}
