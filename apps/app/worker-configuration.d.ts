/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6d195ea284ee6e4912c6d9aa33c8e19)
...
interface __BaseEnv_Env {
	...
	Zine: DurableObjectNamespace<import("./src/server").Zine>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Zine";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "OPENAI_API_KEY" | "WEBHOOK_VERIFY_TOKEN" | "FACEBOOK_AUTH_TOKEN" | "SENDER_PHONE" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
