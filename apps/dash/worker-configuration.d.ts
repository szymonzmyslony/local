/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0f4edf3cbdab5ff2ebfaddcafad4767c)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	DASH_ADMIN_USERNAME: "zine";
	FIRECRAWL_API_KEY: string;
	SUPABASE_URL: string;
	SUPABASE_ANON_KEY: string;
	OPENAI_API_KEY: string;
	OBSERVER: Fetcher /* zine-observer */;
	...
	CLASSIFY_PAGE: Workflow<Parameters<import("./worker/index").ClassifyPage['run']>[0]['payload']>;
	EXTRACT_EVENT_PAGES: Workflow<Parameters<import("./worker/index").ExtractEventPages['run']>[0]['payload']>;
	EXTRACT_AND_EMBED_EVENTS: Workflow<Parameters<import("./worker/index").ExtractAndEmbedEvents['run']>[0]['payload']>;
	EXTRACT_GALLERY: Workflow<Parameters<import("./worker/index").ExtractGallery['run']>[0]['payload']>;
	EMBEDDING: Workflow<Parameters<import("./worker/index").Embed['run']>[0]['payload']>;
	SEED_AND_STARTUP_GALLERY: Workflow<Parameters<import("./worker/index").SeedAndStartupGallery['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DASH_ADMIN_USERNAME" | "FIRECRAWL_API_KEY" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "OPENAI_API_KEY">> {}
}
