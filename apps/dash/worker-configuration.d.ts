/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75665a956221e4e871487f7d05e05e25)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PROMOTE_PAGES: Workflow<Parameters<import("./worker/index").PromotePages['run']>[0]['payload']>;
		SCRAPE_AND_EXTRACT: Workflow<Parameters<import("./worker/index").ScrapeAndExtract['run']>[0]['payload']>;
