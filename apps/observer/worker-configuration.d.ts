/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed8a01572addd73940e76ad18fc49aa8)
...
interface __BaseEnv_Env {
	...
	GalleryObserver: DurableObjectNamespace<import("./src/index").GalleryObserver>;
	LondonScout: DurableObjectNamespace<import("./src/index").LondonScout>;
	GALLERY_OBSERVATION: Workflow<Parameters<import("./src/index").GalleryObservationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GalleryObserver" | "LondonScout";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_API_KEY" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "OBSERVER_ADMIN_TOKEN">> {}
}
